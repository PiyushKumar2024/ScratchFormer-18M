...
head_size=16 #practically useless here (more used in multi headed attention)
...
class BigramLanguageModel(nn.Module):
    def __init__(self, vocab_size):
        ...
        self.sa_head=Head(n_embd) #matching the shape if we take it as 16 then the lm_head will have problem
